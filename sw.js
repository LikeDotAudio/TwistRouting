...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=58',
    './js/util/color.js?v=58',
    './js/util/palette.js?v=58',
    './js/util/dom.js?v=58',
    './js/core/state.js?v=58',
    './js/ui/makeMediaGroup.js?v=58',
    './js/globals.js?v=58',
    './js/poolVideo.js?v=58',
    './js/poolAudio.js?v=58',
    './js/visuals.js?v=58',
    './js/matrix.js?v=58',
    './js/editors/core.js?v=58',
    './js/editors/iso-recorder.js?v=58',
    './js/editors/multi-viewer.js?v=58',
    './js/editors/vision-mixer.js?v=58',
    './js/editors/audio-mixer.js?v=58',
    './js/editors/intercom.js?v=58',
    './js/dragDrop.js?v=58',
    './js/touchDrag.js?v=58',
    './js/productions.js?v=58',
    './js/poolPlayout.js?v=58',
    './js/sources.js?v=58',
    './js/topbar.js?v=58',
    './js/app.js?v=58',
    './js/clock.js?v=58',
    './js/tutorial.js?v=58',
    './js/router-view.js?v=58',
    './js/captains-log.js?v=58',
    './js/portals.js?v=58',
    './js/lcars-pulse.js?v=58',
    './js/dest-selector.js?v=58',
