...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=50',
    './js/util/color.js?v=50',
    './js/util/palette.js?v=50',
    './js/util/dom.js?v=50',
    './js/core/state.js?v=50',
    './js/ui/makeMediaGroup.js?v=50',
    './js/globals.js?v=50',
    './js/poolVideo.js?v=50',
    './js/poolAudio.js?v=50',
    './js/visuals.js?v=50',
    './js/matrix.js?v=50',
    './js/editors/core.js?v=50',
    './js/editors/iso-recorder.js?v=50',
    './js/editors/multi-viewer.js?v=50',
    './js/editors/vision-mixer.js?v=50',
    './js/editors/audio-mixer.js?v=50',
    './js/editors/intercom.js?v=50',
    './js/dragDrop.js?v=50',
    './js/touchDrag.js?v=50',
    './js/productions.js?v=50',
    './js/poolPlayout.js?v=50',
    './js/sources.js?v=50',
    './js/topbar.js?v=50',
    './js/app.js?v=50',
    './js/clock.js?v=50',
    './js/tutorial.js?v=50',
    './js/router-view.js?v=50',
