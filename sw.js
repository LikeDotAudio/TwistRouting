...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=81',
    './js/util/color.js?v=81',
    './js/util/palette.js?v=81',
    './js/util/dom.js?v=81',
    './js/core/state.js?v=81',
    './js/ui/makeMediaGroup.js?v=81',
    './js/globals.js?v=81',
    './js/poolVideo.js?v=81',
    './js/poolAudio.js?v=81',
    './js/visuals.js?v=81',
    './js/matrix.js?v=81',
    './js/editors/core.js?v=81',
    './js/editors/iso-recorder.js?v=81',
    './js/editors/multi-viewer.js?v=81',
    './js/editors/vision-mixer.js?v=81',
    './js/editors/audio-mixer.js?v=81',
    './js/editors/intercom.js?v=81',
    './js/editors/camera-control.js?v=81',
    './js/editors/camera/styles.js?v=81',
    './js/editors/camera/state.js?v=81',
    './js/editors/camera/scopes.js?v=81',
    './js/editors/camera/bars.js?v=81',
    './js/editors/camera/maps.js?v=81',
    './js/editors/camera/controls.js?v=81',
    './js/editors/audio-monitor.js?v=81',
    './js/editors/ifb.js?v=81',
    './js/editors/stagebox-input.js?v=81',
    './js/dragDrop.js?v=81',
    './js/touchDrag.js?v=81',
    './js/productions.js?v=81',
    './js/poolPlayout.js?v=81',
    './js/sources.js?v=81',
    './js/topbar.js?v=81',
    './js/app.js?v=81',
    './js/clock.js?v=81',
    './js/tutorial.js?v=81',
    './js/router-view.js?v=81',
    './js/captains-log.js?v=81',
    './js/portals.js?v=81',
    './js/lcars-pulse.js?v=81',
    './js/dest-selector.js?v=81',
    './js/dialog.js?v=81',
    './js/util/mono-emoji.js?v=81',
    './js/unroute.js?v=81',
    './js/source-filter.js?v=81',
