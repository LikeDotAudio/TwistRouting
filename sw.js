...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=57',
    './js/util/color.js?v=57',
    './js/util/palette.js?v=57',
    './js/util/dom.js?v=57',
    './js/core/state.js?v=57',
    './js/ui/makeMediaGroup.js?v=57',
    './js/globals.js?v=57',
    './js/poolVideo.js?v=57',
    './js/poolAudio.js?v=57',
    './js/visuals.js?v=57',
    './js/matrix.js?v=57',
    './js/editors/core.js?v=57',
    './js/editors/iso-recorder.js?v=57',
    './js/editors/multi-viewer.js?v=57',
    './js/editors/vision-mixer.js?v=57',
    './js/editors/audio-mixer.js?v=57',
    './js/editors/intercom.js?v=57',
    './js/dragDrop.js?v=57',
    './js/touchDrag.js?v=57',
    './js/productions.js?v=57',
    './js/poolPlayout.js?v=57',
    './js/sources.js?v=57',
    './js/topbar.js?v=57',
    './js/app.js?v=57',
    './js/clock.js?v=57',
    './js/tutorial.js?v=57',
    './js/router-view.js?v=57',
    './js/captains-log.js?v=57',
    './js/portals.js?v=57',
    './js/lcars-pulse.js?v=57',
    './js/dest-selector.js?v=57',
