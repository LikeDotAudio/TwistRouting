...
const SHELL = [
    ...
    './index.htm',
    './js/main.js?v=72',
    './js/util/color.js?v=72',
    './js/util/palette.js?v=72',
    './js/util/dom.js?v=72',
    './js/core/state.js?v=72',
    './js/ui/makeMediaGroup.js?v=72',
    './js/globals.js?v=72',
    './js/poolVideo.js?v=72',
    './js/poolAudio.js?v=72',
    './js/visuals.js?v=72',
    './js/matrix.js?v=72',
    './js/editors/core.js?v=72',
    './js/editors/iso-recorder.js?v=72',
    './js/editors/multi-viewer.js?v=72',
    './js/editors/vision-mixer.js?v=72',
    './js/editors/audio-mixer.js?v=72',
    './js/editors/intercom.js?v=72',
    './js/dragDrop.js?v=72',
    './js/touchDrag.js?v=72',
    './js/productions.js?v=72',
    './js/poolPlayout.js?v=72',
    './js/sources.js?v=72',
    './js/topbar.js?v=72',
    './js/app.js?v=72',
    './js/clock.js?v=72',
    './js/tutorial.js?v=72',
    './js/router-view.js?v=72',
    './js/captains-log.js?v=72',
    './js/portals.js?v=72',
    './js/lcars-pulse.js?v=72',
    './js/dest-selector.js?v=72',
    './js/dialog.js?v=72',
    './js/util/mono-emoji.js?v=72',
    './js/unroute.js?v=72',
    './js/source-filter.js?v=72',
